			...
			public void nextPacket(JPacket packet, StringBuilder errbuf) {
				 ...
				 */
                                if(packet.hasHeader(ip)){
                                    ...
                                    /*IP.IPInfo ipInfo = IP.getIPInfo("117.227.59.29");
                                    System.out.printf("Country IP::%s%n", ipInfo.getCountry_name());
                                    */
                                    //http://www.codeproject.com/Articles/772002/Get-Detail-IP-Address-Information-of-any-JAVA-Clie?fid=1859760&df=90&mpp=25&noise=3&prof=True&sort=Position&view=Normal&spc=Relaxed
                                    //http://www.lazylab.org/40/java/resolve-ip-to-country-name-in-java/
				...
				if (packet.hasHeader(Tcp.ID)) {
					 ...
					 */
					packet.getHeader(tcp);
                                        //System.out.printf("tcp.dst_ip=%d%n", tcp.);
