...
//https://javaho.wordpress.com/2011/07/03/server-side-sample-code-to-get-latitude-and-longitude-of-a-given-address-using-google-map-api/
//https://github.com/mathur/journey/blob/master/java/com/rohan/journey/LongLatService.java
...
public class GetIt {
    ...
    public static void main(String[] args) throws Exception {
        ...
        tDirectionService.getLongitudeLatitude("Rue A Millesch 27, Roodt-sur-Syre, Luxembourg");
    }
